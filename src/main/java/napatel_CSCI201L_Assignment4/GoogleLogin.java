...
public class GoogleLogin extends HttpServlet {
	...
	// Accepts the validated email and id_token and either signs up the user or
	// fails and returns JSON data
	public static String googleSSO(String email, String id_token) {
		...
		// If the code is here, then the user is in the database already. First, check
		// if they are a google user
